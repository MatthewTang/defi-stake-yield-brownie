...
def deploy_token_farm_and_dapp_token(front_end_update=False):
    ...
    tx.wait(1)
    # add tokens to the token farm and associate token contract address
...
# in real world, we just copy and paste the addresses to the frontend
def update_front_end():
    # send the build folder
    copy_folders_to_front_end("./build", "./front_end/src/chain-info")

    # typescript work with json instead of yaml
